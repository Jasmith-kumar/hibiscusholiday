      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-stone-100 space-y-8">
            ...
            <section>
              <h2 className="text-2xl font-serif font-bold text-stone-900 mb-4">1. Information We Collect</h2>
            ...
            <section>
              <h2 className="text-2xl font-serif font-bold text-stone-900 mb-4">2. How We Use Your Information</h2>
              <p className="text-stone-600 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-serif font-bold text-stone-900 mb-4">3. Information Sharing</h2>
            ...
            <section>
              <h2 className="text-2xl font-serif font-bold text-stone-900 mb-4">4. Data Security</h2>
              <p className="text-stone-600 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-serif font-bold text-stone-900 mb-4">5. Your Rights</h2>
              <p className="text-stone-600 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-serif font-bold text-stone-900 mb-4">6. Cookies</h2>
              <p className="text-stone-600 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-serif font-bold text-stone-900 mb-4">7. Changes to This Policy</h2>
              <p className="text-stone-600 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-serif font-bold text-stone-900 mb-4">8. Contact Us</h2>
              <p className="text-stone-600 leading-relaxed">
                If you have any questions about this Privacy Policy or our data practices, please contact us at:
              </p>
              <div className="mt-4 p-6 bg-hibiscus-50 rounded-2xl">
